...
"""
files just imports external dependencies. Do not import any boofinity modules here for sake of delayed imports.
"""
...
class OptionalImports:
    ...
    def _raise_error(self) -> None:
        ...
        msg = (
            ...
            f"install via `pip install boofinity[{self.extra_install}]`"
        )
...
CHECK_QWEN_VL_UTILS = OptionalImports("qwen_vl_utils", "qwen3vl")
