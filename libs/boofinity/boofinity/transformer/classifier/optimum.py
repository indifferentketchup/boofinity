...
from boofinity._optional_imports import CHECK_ONNXRUNTIME, CHECK_TRANSFORMERS
from boofinity.args import EngineArgs
from boofinity.transformer.abstract import BaseClassifer
from boofinity.transformer.utils_optimum import (
    device_to_onnx,
    get_onnx_files,
    optimize_model,
)
...
class OptimumClassifier(BaseClassifer):
    def __init__(self, *, engine_args: EngineArgs):
        ...
        model = optimize_model(
            ...
            optimize_model=not os.environ.get("BOOFINITY_ONNX_DISABLE_OPTIMIZE", False),
        )
